#' Make Stan data object for BRC model
#'
#' @param A The number of participant age groups
#' @param C The number of contact age groups
#' @param dt_contacts A data.table object containing the contact count data
#' @param dt_offsets A data.table object containing the participant offset data
#' @param dt_population A data.table object containing the population data
#' @param model_params A list containing the model parameters
#'
#' @return Stan data object
#' @export
...
init_stan_data <- function(A = 85, C = 13) {
  # Single waves
  return(list(A = A, C = C))
}
...
add_contact_vector <- function(stan_data, dt_contacts){
...
#' Add observation counts to the Stan data object
#'
#' This function adds observation counts to the Stan data object. The observation
#' counts are generated from a data.table object of contact data, which must
#'
add_N <- function(stan_data){
