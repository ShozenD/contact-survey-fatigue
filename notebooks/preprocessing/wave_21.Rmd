...
The list of variables to include as fixed effects in the model is as follows:
- Full-time parent, home-maker
- Long-term sick or disabled
- Unemployed [Not seeking job]
- Unemployed [Seeking job]

We exclude underage children and retired individuals as they are heavily correlated with age.
...
saveRDS(data, "../../data/silver/covimod-wave-21.rds")
```
